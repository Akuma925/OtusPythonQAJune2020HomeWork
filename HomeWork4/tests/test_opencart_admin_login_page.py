...
from page_object import UserLoginPage
...
def test_login_admin(browser, url, wait):
    ...
    # логинемся в админку
    UserLoginPage.UserLoginPage.open_page(admin_login_page_url)
    UserLoginPage.UserLoginPage.log_in_as_user()
